    ...
    test_Packages this)
{
    ...
    test_assert(!strcmp(corto_idof(md_Doc(h3)->o), "method0()"));
    ...
    test_assert(corto_instanceof(md_Doc_o, h3));
    test_assert(md_Doc(h3)->o != NULL);
    test_assert(!strcmp(corto_idof(md_Doc(h3)->o), "method1()"));
    test_assert(corto_parentof(md_Doc(h3)->o) == md_Doc(h2)->o);
...
void test_Packages_tc_nestedPackage(
    test_Packages this)
{
    ...
    test_assert(corto_instanceof(md_Doc_o, h1));
    test_assert(md_Doc(h1)->o != NULL);
    test_assert(!strcmp(corto_idof(md_Doc(h1)->o), "Package1"));
    test_assert(corto_parentof(md_Doc(h1)->o) == test_o);
    test_assert(md_Doc(h1)->text == NULL);
    test_assert(md_Doc(h1)->level == 1);
    corto_release(h1);
    ...
    test_assert(corto_instanceof(md_Doc_o, h2));
    test_assert(md_Doc(h2)->o != NULL);
    test_assert(!strcmp(corto_idof(md_Doc(h2)->o), "Package0"));
    test_assert(corto_parentof(md_Doc(h2)->o) == md_Doc(h1)->o);
    ...
    test_assert(corto_instanceof(md_Doc_o, h3));
    test_assert(md_Doc(h3)->o != NULL);
    test_assert(!strcmp(corto_idof(md_Doc(h3)->o), "Package0"));
    test_assert(corto_parentof(md_Doc(h3)->o) == md_Doc(h2)->o);
...
void test_Packages_tc_twoClasses(
    test_Packages this)
{
    ...
    test_assert(corto_instanceof(md_Doc_o, h1));
    test_assert(md_Doc(h1)->o != NULL);
    test_assert(!strcmp(corto_idof(md_Doc(h1)->o), "Package2"));
    test_assert(corto_parentof(md_Doc(h1)->o) == test_o);
    test_assert(md_Doc(h1)->text == NULL);
    test_assert(md_Doc(h1)->level == 1);
    corto_release(h1);
    ...
    test_assert(corto_instanceof(md_Doc_o, h2));
    test_assert(md_Doc(h2)->o != NULL);
    test_assert(!strcmp(corto_idof(md_Doc(h2)->o), "Class1"));
    test_assert(corto_parentof(md_Doc(h2)->o) == md_Doc(h1)->o);
